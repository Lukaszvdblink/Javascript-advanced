...
const middelsteGetallen = getallen.filter(t => t > 10 && t < 20);
...
const langeAwoorden = woorden.filter(w => w[0] === 'a' && w.length > 5);
console.log('Lange woorden met a:', langeAwoorden);

// TODO: Filter even getallen die groter zijn dan 15
const groteEvenGetallen = getallen.filter(t => t % 2 === 0 && t > 15);
